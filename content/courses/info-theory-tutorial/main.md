...
<table class="table">
  <tbody>
    <tr>
      ...
      <td><a href="https://drive.google.com/file/d/1psXH8XsRQOg6bHoj4r6rJcmF0O4wfNIv/view?usp=sharing" target="_blank">Slides</a></td>
      <td><a href="https://colab.research.google.com/drive/16ay4Em4Ctn4ETUH1f5ww1JgzSJVk4G23?usp=sharing" target="_blank">Colab Notebook</a></td>
    </tr>
    <tr>
      <th scope="row">Module 2</th>
      <td>Case Studies in Complexity</td>
      <td><a href="https://drive.google.com/file/d/16_c9Jc_UfTXk4MnPPQToHGZLdn3leFTs/view?usp=sharing" target="_blank">Slides</a></td>
      <td><a href="https://colab.research.google.com/drive/1-Us6wDresyP-MDu7e7IlUp1vDtnkl_ya?usp=sharing" target="_blank">Colab Notebook</a></td>
    </tr>
    <tr>
      <th scope="row">Module 3</th>
      <td>Case Studies in Correlation</td>
      <td><a href="https://drive.google.com/file/d/1TjWy-0xwRqjOtSFS1kOnY8hGquDtdvCV/view?usp=sharing" target="_blank">Slides</a></td>
      <td></td>
    </tr>
    <tr>
...
<table class="table" style='word-wrap:break-word'>
  ...
  <tbody>
    ...
    <tr>
      <td></td>
      <td><a href="https://aclanthology.org/2022.acl-short.20/" target="_blank">Estimating the Entropy of Linguistic Distributions</a></td>
      <td>Aryaman Arora and Clara Isabel Meister and Ryan Cotterell</td>
      <td><button type="button" class="btn btn-outline-primary my-1 mr-1{{ if $is_list }} btn-sm{{end}} js-cite-modal"
        data-filename="bibs/arora22.bib">Cite</button></td>
    </tr>
