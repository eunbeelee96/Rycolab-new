...
- icon: envelope
  icon_pack: fas
  link: "mailto:ce.zhang@inf.ethz.ch"  # For a direct email link, use "mailto:test@example.org".
- icon: google
  icon_pack: fab
  link: https://scholar.google.ch/citations?hl=en&user=GkXqbmMAAAAJ
- icon: profile
  icon_pack: fab
  link: https://zhangce.github.io/
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/DS3Lab
